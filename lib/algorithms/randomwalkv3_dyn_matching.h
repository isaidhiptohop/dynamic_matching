...
#ifndef RANDOMWALKV3_DYN_MATCHING_H
#define RANDOMWALKV3_DYN_MATCHING_H
...
*/
class randomwalkv3_dyn_matching : public dyn_matching {
public:
    randomwalkv3_dyn_matching (dyn_graph_access* G);
...
#endif // RANDOMWALKV3_DYN_MATCHING_H
