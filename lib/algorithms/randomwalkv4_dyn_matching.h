...
#ifndef RANDOMWALKV4_DYN_MATCHING_H
#define RANDOMWALKV4_DYN_MATCHING_H
...
*/
class randomwalkv4_dyn_matching : public dyn_matching {
public:
    randomwalkv4_dyn_matching (dyn_graph_access* G, double eps);
...
//    random_functions rng;
    ...
    bool settle (NodeID u);
};

#endif // RANDOMWALKV4_DYN_MATCHING_H
