...
#ifndef RANDOMWALKV5_DYN_MATCHING_H
#define RANDOMWALKV5_DYN_MATCHING_H
...
*/
class randomwalkv5_dyn_matching : public dyn_matching {
public:
    randomwalkv5_dyn_matching (dyn_graph_access* G, double eps);
...
//    random_functions rng;
    ...
    void settle (NodeID u);
};

#endif // RANDOMWALKV5_DYN_MATCHING_H
