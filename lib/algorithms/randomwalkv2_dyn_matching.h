...
#ifndef RANDOMWALKV2_DYN_MATCHING_H
#define RANDOMWALKV2_DYN_MATCHING_H
...
*/
class randomwalkv2_dyn_matching : public dyn_matching {
public:
    randomwalkv2_dyn_matching (dyn_graph_access* G, double eps);
...
#endif // RANDOMWALKV2_DYN_MATCHING_H
